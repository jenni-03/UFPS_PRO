    ...
    if (respuestas.length === 0){
        ...
        for (const respuesta of respuestas) {
            ...
            if (respuesta.opcion === null){
                ...
                respuestas_final[respuesta.pregunta_id] = respuesta.opcion + 1;
        ...
        for (let configuracionCategoria of prueba.Configuraciones_categorias) {
            ...
            const puntajeMaxPregunta = puntajeMaxCategoria / configuracionCategoria.total_preguntas;
            ...
            for (const pregunta of configuracionCategoria.Preguntas) {
                ...
                if (respuestas_final.hasOwnProperty(pregunta.id)){
                    ...
                    posicion_respuesta = posicionEnAlfabeto(pregunta.respuesta);

                    if (respuestas_final[pregunta.id_pregunta] === pregunta.respuesta) {
